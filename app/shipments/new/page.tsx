      ...
      {navigation.map(
        ({
          ...
          <Link
            key={label}
            href={href}
            className="flex min-h-11 w-full items-center gap-3 rounded-lg px-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-50 hover:text-slate-950"
          >
        ...
        <div className="mx-auto max-w-[1440px] px-5 py-8 sm:px-8 sm:py-10 lg:px-10">
          ...
          <section className="mt-7">
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-slate-500">
              Create a shipment and connect it to an existing customer.
            </p>
          </section>
          ...
          {/* Workflow note */}
          <section className="mt-6 rounded-xl border border-blue-100 bg-blue-50/60 p-5 sm:p-6">
            <p className="text-xs font-bold uppercase tracking-[0.12em] text-blue-600">
              What happens next
            </p>

            <p className="mt-2 text-sm leading-6 text-slate-600">
              After the shipment is created, dispatch will be able to assign
              an available driver and vehicle. Status updates and shipment
              history will be added in the next shipment workflow step.
            </p>
          </section>
